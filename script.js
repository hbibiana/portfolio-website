...
const translations = {
  sk: {
    ...
    shortAboutme:"Tvorím webové projekty s dôrazom na prehľadnosť, funkčnosť a používateľský zážitok, pričom sa neustále rozvíjam v oblasti moderných front-end technológií.",
    ...
    textEducation: "Vyštudovala som Hospodársku informatiku a Informačný manažment na Ekonomickej univerzite v Bratislave. Štúdium mi poskytlo silné základy v oblasti informačných systémov, spracovania dát, procesného myslenia a analytického prístupu k riešeniu problémov.",
    textWork:"Moje predchádzajúce pracovné pôsobenie mi pomohlo vybudovať si silné analytické a organizačné schopnosti. Skúsenosti s prácou v interných systémoch, analýzou dát a spoluprácou naprieč tímami dnes tvoria pevný základ pre môj profesijný rozvoj vo front-end developmente.",
    textSkills:"HTML5, CSS3, JavaScript, Git, GitHub a SQL. Analytické myslenie a dôraz na detail. Schopnosť efektívne riešiť problémy, dobre komunikovať a tímovo spolupracovať. Som spoľahlivá, organizovaná a rýchlo sa učím.",
  ...
  en: {
    ...
    textWork:"My previous professional experience has helped me develop strong analytical and organizational skills. Working with internal systems, data analysis, and cross-team collaboration now provides a solid foundation for my professional growth in front-end development.",
    textSkills:"HTML5, CSS3, JavaScript, Git, GitHub, and SQL. Analytical thinking and strong attention to detail. Experience in data processing, reporting, and working with internal systems. A problem-solving mindset with communication and team collaboration skills. Reliable, organized, and a fast learner.",
    textCourses:"I attended an accredited course Front-end programmer at Skillmea platform.",
